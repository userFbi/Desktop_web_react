    ...
    return (
        ...
        >
            ...
            <main className="grid grid-cols-1 sm:grid-cols-[repeat(auto-fill,minmax(300px,1fr))] gap-[20px] mt-12">
                {filtered.map(item => (
                    <div key={item.id} className="vault-card bg-[#0d0d0d] border border-[#151515] p-6 transition-all duration-300 hover:border-[#b3a577] hover:bg-[#0f0f0f]">
                        <div className="flex justify-between mb-6">
                            ...
                            <button onClick={() => deleteKey(item.id)} className="text-zinc-800 hover:text-red-500 flex-shrink-0">
                            ...
                            <div>
                                ...
                                <div className="flex justify-between items-center bg-[#050505] p-3 border border-white/5">
                                    ...
                                    <div className="flex gap-3 flex-shrink-0">
                                        <button onClick={() => togglePass(item.id)} className="opacity-40 hover:opacity-100 hover:text-[#b3a577]">
